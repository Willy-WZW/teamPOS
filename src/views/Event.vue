...
<template>
  <div class="big">
    ...
    <div class="mainArea">
      <vue-cal @cell-click="onDateSelect" style="width: 300px; margin-bottom: 20px;":disable-views="['years','year','week', 'multi-day', 'day']" />
      
      <div>
        <div
          v-for="announce in filterAnnouncementsByDate()"
