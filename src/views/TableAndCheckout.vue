...
export default {
    ...
    computed: {
        ...
        filteredReservations() {
            ...
            if (this.searchNumber) {
                reservationsByDate = reservationsByDate.filter(
                    (reservation) => reservation.phone.endsWith(this.searchNumber) // 檢查電話號碼是否以搜尋號碼結尾
                );
            }
    ...
    methods: {
        ...
        async searchReservations() {
            if (this.reservationSearchNumber.trim() === "") {
                // 使用新的變數名稱
        ...
        async manualCheckIn(tableNumber, reservationId) {
            try {
                ...
                // 成功提示
                Swal.fire("報到成功！", `桌號 ${tableNumber} 已成功報到。`, "success");
                ...
                // 顯示錯誤提示
                Swal.fire("報到失敗！", "報到時發生錯誤，請稍後重試。", "error");
            }
        },
        ...
        async deleteReservation(reservationId) {
            try {
                ...
                // 成功提示
                Swal.fire("取消成功！", "該訂位已被成功取消", "success");
                ...
                // 顯示錯誤提示
                Swal.fire("取消失敗！", "取消訂位時發生錯誤，請稍後再試", "error");
            }
        },
        ...
        async searchWaitlist() {
            if (this.waitlistSearchNumber.trim() === "") {
                // 使用新的變數名稱
        ...
        async manualCheckInWait(waitlistId) {
            try {
                ...
                // 成功提示
                Swal.fire("報到成功！", response.data.message, "success");
                ...
                .then((data) => {
                    if (data.code == 200) {
                        ...
                        data.data.orderMealId.forEach((item) => {
                            ...
                            let mealArray = mealString.split(/(?<=\)),\s*/).map(meal => meal.trim());
        ...
        <div class="tableReservationArea">
            ...
            <div class="tableArea">
                ...
                <div class="tableHeader">
                    ...
                    <!-- 刷新按鈕 -->
                    <button class="refreshButton" @click="refresh"><i class="fa-solid fa-arrows-rotate"></i>刷新</button>
                </div>

                <!-- 桌位狀態 -->
                <div class="status"><span class="activeDot"></span> 用餐中 <span class="reservedDot"></span> 已訂位 <span class="availableDot"></span> 可使用</div>
                ...
                <div class="tableGrid">
                    <div
                        ...
                        <div :class="['circle', table.status]" @click="selectTable(table)">
                            ...
                            <div class="tableCapacity"><i class="fa-solid fa-user-group"></i> {{ table.capacity }}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="sideBody">
                        ...
                        -->
                            ...
                            <div v-if="paymentMethod === 'cash'" class="cashForm">
                                <div>
                                    <input type="number" placeholder="輸入收取金額" v-model="receivedAmount" @input="calculateChange" @keypress="onlyNumbers" />
                                </div>
            ...
            <div class="reservationArea">
                ...
                <div class="reservationHeader">
                    <button :class="{ active: viewType === 'reservation' }" @click="viewType = 'reservation'">訂位</button>
                    <button :class="{ active: viewType === 'waitlist' }" @click="viewType = 'waitlist'">現場候位</button>
                </div>
                ...
                <div v-if="viewType === 'reservation'" class="reservations">
                    ...
                    <div class="reminderAndSearchArea">
                        ...
                        <input
                            v-if="isSearchingForReservation"
                            type="search"
                            v-model="reservationSearchNumber"
                            placeholder="請輸入電話號碼 (末三碼)"
                            @input="searchReservations"
                            @blur="handleBlur('reservation')"
                            class="searchInput"
                            ref="reservationSearchInput" />
                    </div>
                    ...
                    <div v-for="reservation in filteredReservations" :key="reservation.id" class="reservationItem">
                        ...
                        <div class="tableNumberAndTime">
                            <div class="tableNumbers">{{ reservation.tables.join(", ") }}</div>
                            <!-- 顯示所有桌號 -->
                ...
                <div v-if="viewType === 'waitlist'" class="waitlist">
                    ...
                    <div class="reminderAndSearchArea">
                        ...
                        <input
                            v-if="isSearchingForWaitlist"
                            type="search"
                            v-model="waitlistSearchNumber"
                            placeholder="請輸入電話號碼 (末三碼)"
                            @input="searchWaitlist"
                            @blur="handleBlur('waitlist')"
                            class="searchInput"
                            ref="waitlistSearchInput" />
                    </div>
                ...
                <div class="modalContent" @click.stop>
                    ...
                    <div class="contactInfoArea">
                        ...
                        <div class="nameAndTitleArea">
                            ...
                            <!-- 稱謂選擇 -->
                            <div class="titleArea">
                                <label> <input type="radio" v-model="newReservation.title" value="先生" /> 先生 </label>
                                <label> <input type="radio" v-model="newReservation.title" value="小姐" /> 小姐 </label>
                                <label> <input type="radio" v-model="newReservation.title" value="其他" /> 其他 </label>
                            </div>
                        </div>
                ...
                <div class="modalContent" @click.stop>
                    ...
                    <div class="contactInfoArea">
                        ...
                        <div class="nameAndTitleArea">
                            ...
                            <!-- 稱謂選擇 -->
                            <div class="titleArea">
                                <label> <input type="radio" v-model="newWaitlist.title" value="先生" /> 先生 </label>
                                <label> <input type="radio" v-model="newWaitlist.title" value="小姐" /> 小姐 </label>
                                <label> <input type="radio" v-model="newWaitlist.title" value="其他" /> 其他 </label>
                            </div>
                        </div>
